...
$product->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
...
old('title', $product->title) }}" placeholder="Masukkan Judul
Product">
...
@error('description') is-invalid @enderror" name="description"
                                        rows="5" placeholder="Masukkan Description Product">{{
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('price', $product->price) }}" placeholder="Masukkan
Harga Product">
                                            <!-- error message untuk
price -->
                                            @error('price')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('stock', $product->stock) }}" placeholder="Masukkan
Stock Product">
                                            <!-- error message untuk
stock -->
                                            @error('stock')
...
ndle.min.js"></script>
<script
    src="https://cdn.ckeditor.com/4.24.1/standard/ckeditor.js"></script>
<script>
